...
const reviews = [
  {
    name: "Sarah Chen",
    username: "@sarahchen",
    body: "Chat reduced our support ticket response time by 60%. The AI understands context incredibly well and our customers love the instant responses.",
    img: "https://notion-avatars.netlify.app/api/avatar?preset=female-1",
  },
  {
    name: "Marcus Johnson",
    username: "@marcusj",
    body: "We've seen a 40% reduction in support costs since implementing Chat. It handles routine queries flawlessly, letting our team focus on complex issues.",
  ...
  },
  {
    ...
    body: "The setup was surprisingly simple. Within hours, Chat was answering customer questions with accuracy that rivals our best human agents.",
  ...
  },
  {
    name: "David Kim",
    username: "@davidkim",
    body: "Our customer satisfaction scores jumped 25% after deploying Chat. It's like having a 24/7 support team that never sleeps.",
  ...
  },
  {
    name: "Priya Patel",
    username: "@priyapatel",
    body: "Chat's multilingual support opened up global markets for us. We now serve customers in 12 languages without hiring additional staff.",
    ...
    <div id="testimonials" className="max-w-7xl mx-auto py-24 sm:py-32">
      <div className="text-center mb-16">
        ...
        <p className="text-lg md:text-xl text-neutral-600 dark:text-neutral-400 max-w-3xl mx-auto">
          ...
          support with Chat. Here&apos;s what they have to say about real
          results.
        </p>
      </div>
