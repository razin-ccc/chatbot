...
export function FeaturesSection() {
    const features = [
        ...
        {
            title: "Streaming Gemini Responses",
            description:
        ...
        {
            title: "Conversation-Scoped Documents",
            description:
                "Upload PDF or TXT files to a specific conversation. Documents stay attached to that thread only.",
            icon: <FileText />,
        },
        {
            title: "Document-Grounded RAG Mode",
            description:
                "Route questions through Chroma retrieval and get Gemini answers grounded in indexed document chunks.",
            icon: <SearchCheck />,
        },
        {
        ...
        <div id="features" className="max-w-7xl mx-auto py-16">
            ...
            >
                ...
                <p className="text-lg md:text-xl text-neutral-600 dark:text-neutral-400 max-w-3xl mx-auto">
                    A full-stack Gemini chat app with protected accounts, persistent threads,
                    streaming responses, and conversation-scoped document grounding.
                </p>
            </motion.div>
